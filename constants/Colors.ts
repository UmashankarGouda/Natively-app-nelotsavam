...
// Farm-themed colors for Nelotsavam
export const farmColors = {
  primary: "#4CAF50",      // Main green
  secondary: "#81C784",    // Light green
  accent: "#FFC107",       // Gold for rewards
...
export const Colors = {
  light: {
    ...
    tint: tintColorLight,
    icon: farmColors.textSecondary,
    tabIconDefault: farmColors.textSecondary,
